      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-lg border p-6" style={{ borderColor: '#D0DAF0' }}>
            <p className="text-sm" style={{ color: '#5A6A8A' }}>管理部への依頼（未対応）</p>
            <p className="text-3xl font-bold mt-2 text-red-500">0</p>
          </div>
          <div className="bg-white rounded-lg border p-6" style={{ borderColor: '#D0DAF0' }}>
            <p className="text-sm" style={{ color: '#5A6A8A' }}>更新期限超過</p>
            <p className="text-3xl font-bold mt-2 text-red-500">0</p>
          </div>
          <div className="bg-white rounded-lg border p-6" style={{ borderColor: '#D0DAF0' }}>
            <p className="text-sm" style={{ color: '#5A6A8A' }}>更新期限14日以内</p>
            <p className="text-3xl font-bold mt-2 text-yellow-500">0</p>
          </div>
          <div className="bg-white rounded-lg border p-6" style={{ borderColor: '#D0DAF0' }}>
            <p className="text-sm" style={{ color: '#5A6A8A' }}>署名未完了（期限切れ）</p>
            <p className="text-3xl font-bold mt-2 text-yellow-500">0</p>
          </div>
        </div>
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-white rounded-lg border p-6" style={{ borderColor: '#D0DAF0' }}>
            ...
            <p className="text-sm" style={{ color: '#5A6A8A' }}>現在、未対応の依頼はありません。</p>
          </div>
          <div className="bg-white rounded-lg border p-6" style={{ borderColor: '#D0DAF0' }}>
          ...
          <div className="bg-white rounded-lg border p-6" style={{ borderColor: '#D0DAF0' }}>
            <h2 className="text-base font-bold mb-4" style={{ color: '#1A2340' }}>署名未完了</h2>
            <p className="text-sm" style={{ color: '#5A6A8A' }}>現在、署名未完了の書類はありません。</p>
          </div>
          <div className="bg-white rounded-lg border p-6" style={{ borderColor: '#D0DAF0' }}>
            <h2 className="text-base font-bold mb-4" style={{ color: '#1A2340' }}>マスタ更新推奨</h2>
            <p className="text-sm" style={{ color: '#5A6A8A' }}>現在、更新が必要なマスタはありません。</p>
          </div>
        </div>
      </main>
    </div>
