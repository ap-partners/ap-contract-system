...
// 2026-07-10修正：word => [word]（単語を1つの塊として扱い、途中で一切改行しない）だと、
// スペースを含まない長い日本語の自由記述（就業場所・業務内容等）が「1つの巨大な単語」として
// 扱われ、欄の幅を超えても改行できず罫線の外にはみ出す不具合が発生することが判明
// （伊藤さん報告・0710-01.pdf「就業場所と従事すべき業務内容が枠をはみ出す」）。
